...
@test "show_help muestra información de uso" {
...
@test "dns_check sin parámetros muestra error" {
...
@test "dns_check crea un directorio de salida" {
...
@test "dns_check crea archivos CSV con encabezados" {
    run_script dns_check example.com 80 "$OUTPUT_DIR"
    [ "$status" -eq 0 ]
...
@test "El comando de help funciona" {
